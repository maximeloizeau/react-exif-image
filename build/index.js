...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadImage = __webpack_require__(20);
	  ...
	  _createClass(ExifImage, [{
	    ...
	    value: function processImageBuffer(_ref) {
	      ...
	      _loadImage2.default.parseMetaData(new Blob([response], { type: contentType }), function (data) {
	        var orientation = data.exif.getAll().Orientation;
	        _this2.setState({
	          imgStyle: _this2.rotationStyleMap[orientation]
	        });
	        if (_this2.willRotate.indexOf(orientation) > -1) {
	          var imgTag = _react2.default.findDOMNode(_this2.refs.img);
	          var containerStyle = Object.assign(_this2.state.containerStyle, {
	    ...
	    value: function handleUrlUpdate(url) {
	      return this.fetchImage(url).then(this.processImageBuffer).catch(function (e) {
	        console.error(e);
	      });
	    }
	  }, {
